    ...
    def apply_move(self, x, y, color):
        ...
        for dx, dy in Board.DIRECTIONS:
            ...
            if (
                ...
                flip.append((nx, ny)) # we add the newly scanned disc to the list of disc to flip
                nx += dx
                ny += dy
                # we initialise the looping in the direction we scanned up until we hit the bound of the board or reach an ally disc,
